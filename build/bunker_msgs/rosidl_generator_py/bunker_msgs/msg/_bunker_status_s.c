...
bool bunker_msgs__msg__bunker_actuator_state__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * bunker_msgs__msg__bunker_actuator_state__convert_to_py(void * raw_ros_message);

ROSIDL_GENERATOR_C_EXPORT
bool bunker_msgs__msg__bunker_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("bunker_msgs.msg._bunker_status.BunkerStatus", full_classname_dest, 43) == 0);
  }
  bunker_msgs__msg__BunkerStatus * ros_message = _ros_message;
  {  // header
  ...
  {  // actuator_states
    ...
    Py_ssize_t size = 2;
    bunker_msgs__msg__BunkerActuatorState * dest = ros_message->actuator_states;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!bunker_msgs__msg__bunker_actuator_state__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of BunkerStatus */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("bunker_msgs.msg._bunker_status");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BunkerStatus");
  ...
  {  // actuator_states
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = bunker_msgs__msg__bunker_actuator_state__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
