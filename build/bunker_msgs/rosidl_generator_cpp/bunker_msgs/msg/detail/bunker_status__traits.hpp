...
inline std::string to_yaml(const BunkerStatus & msg, bool use_flow_style = false)
{
...
inline std::string to_yaml(const bunker_msgs::msg::BunkerStatus & msg)
{
