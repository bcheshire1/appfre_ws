...
static const _BunkerRCState_type_support_symbol_names_t _BunkerRCState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, bunker_msgs, msg, BunkerRCState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, bunker_msgs, msg, BunkerRCState)),
  }
};
...
{
  return &::bunker_msgs::msg::rosidl_typesupport_cpp::BunkerRCState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, bunker_msgs, msg, BunkerRCState)() {
  return get_message_type_support_handle<bunker_msgs::msg::BunkerRCState>();
}
